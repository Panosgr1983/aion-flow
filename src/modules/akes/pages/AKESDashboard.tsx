        ...
        <div className="p-4 space-y-4 text-xs text-gray-400">
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              <h3 className="text-xs font-medium text-gray-300 uppercase tracking-wider">Data Source</h3>
              <p>Reads <code className="text-cyan-400">documentation.db.json</code> (generated by <code className="text-cyan-400">npm run docs:index</code> from 159 .md files)</p>
              <p><span className="text-gray-500">Runtime:</span> Loaded via <code className="text-cyan-400">fetch('/documentation.db.json')</code> on component mount</p>
              <p><span className="text-gray-500">Build-time:</span> Bundled as static asset with Vercel deployment</p>
              <p><span className="text-gray-500">Refresh:</span> Run <code className="text-cyan-400">npm run docs:index</code> locally, commit, deploy</p>
            </div>
            <div className="space-y-2">
          ...
          <div className="pt-3 border-t border-gray-800 text-center text-[10px] text-gray-600">
            ...
            <p>Source: <code className="text-cyan-400">documentation.db.json</code> · Generated: <code className="text-cyan-400">npm run docs:index</code> · Route: <code className="text-cyan-400">/dashboard/akes</code> · Super Admin only</p>
          </div>
        </div>
      </div>
    </div>
