...
function WaveDivider({ fill, height = 60 }: { fill: string; height?: number }) {
  return (
...
function SectionLabel({ num, total }: { num: number; total: number }) {
  return (
    <span className="text-[11px] font-mono tracking-widest text-blue-400/60 block mb-2">
...
/* ═══════════════════════════════════════════
   PAGE
   ═══════════════════════════════════════════ */
export default function LandingPageNewV5() {
  const [scrollY, setScrollY] = useState(0);
  const [menuOpen, setMenuOpen] = useState(false);
  const [activeSection, setActiveSection] = useState('hero');
  const [heroLinesVisible, setHeroLinesVisible] = useState(false);
  ...
  // Hero stagger trigger
  useEffect(() => { const t = setTimeout(() => setHeroLinesVisible(true), 300); return () => clearTimeout(t); }, []);
  ...
  return (
    <div className="min-h-screen bg-stone-50 text-gray-900 overflow-x-hidden relative">
      ...
      <section id="hero" className="relative min-h-screen flex items-center px-6 pt-24 pb-16 overflow-hidden bg-stone-50">
        ...
        <div className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-l from-white/90 via-white/60 to-transparent pointer-events-none md:block" />
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          {Array.from({ length: 6 }, (_, i) => (
            <div key={i} className="absolute bg-blue-500/10 rounded-full"
              style={{
                left: `${10 + Math.random() * 50}%`, top: `${10 + Math.random() * 80}%`,
        ...
        <div className="relative w-full max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center z-10">
          <div>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight tracking-tight" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
              <span className="hero-line inline-block" style={{ animationDelay: heroLinesVisible ? '0s' : '9s', opacity: heroLinesVisible ? 1 : 0 }}>Το Operating System</span><br />
              <span className="hero-line inline-block bg-gradient-to-r from-blue-600 via-cyan-500 to-teal-500 bg-clip-text text-transparent" style={{ animationDelay: heroLinesVisible ? '.15s' : '9s', opacity: heroLinesVisible ? 1 : 0 }}>
                της δικής σου
              </span><br />
              <span className="hero-line inline-block" style={{ animationDelay: heroLinesVisible ? '.3s' : '9s', opacity: heroLinesVisible ? 1 : 0 }}>επιχείρησης.</span>
            </h1>
      ...
      <WaveDivider fill="#fafaf9" height={55} />
      ...
      <section id="problem" className="relative py-28 px-6 overflow-hidden bg-gray-950"
        ...
        <ParallaxBg src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1600&q=80" speed={0.12} />
      ...
      <WaveDivider fill="#030712" height={55} />

      {/* ═══════════════════════════════
          PLATFORM
          ═══════════════════════════════ */}
      <section id="platform" className="relative py-28 px-6 overflow-hidden bg-stone-50">
        <ParallaxBg src="https://images.unsplash.com/photo-1497366216548-37526070297c?w=1600&q=80" speed={0.15} />
        <div className="absolute inset-0 bg-stone-50/92 backdrop-blur-[1px]" />

        <div className="relative max-w-5xl mx-auto z-10">
          <Reveal>
            <div className="text-center mb-16">
              <SectionLabel num={2} total={7} />
      ...
      {/* ═══════════════════════════════
          MODULES + STATS
          ═══════════════════════════════ */}
      <section id="modules" className="relative py-28 px-6 overflow-hidden bg-white">
        <ParallaxBg src="https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=1600&q=80" speed={0.13} />
        <div className="absolute inset-0 bg-white/92 backdrop-blur-[1px]" />

        <div className="relative max-w-6xl mx-auto z-10">
          <Reveal>
            <div className="text-center mb-16">
              <SectionLabel num={3} total={7} />
          ...
          {/* Stats Row */}
          <Reveal delay={200}>
            <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-8 max-w-3xl mx-auto border-t border-gray-200/60 pt-12">
              {[
                { label: 'Modules', target: 8 },
                { label: 'Industry Blueprints', target: 6 },
                { label: 'Built-in Tools', target: 24 },
      ...
      {/* ═══════════════════════════════
          INDUSTRIES
          ═══════════════════════════════ */}
      <section id="industries" className="relative py-28 px-6 overflow-hidden bg-stone-50">
        <ParallaxBg src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=1600&q=80" speed={0.14} />
        <div className="absolute inset-0 bg-stone-50/90 backdrop-blur-[1px]" />

        <div className="relative max-w-6xl mx-auto z-10">
          <Reveal>
            <div className="text-center mb-16">
              <SectionLabel num={5} total={7} />
      ...
      <section id="growth" className="relative py-28 px-6 overflow-hidden bg-gray-950"
        ...
        <ParallaxBg src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=1600&q=80" speed={0.13} />
        ...
        <svg className="absolute inset-0 w-full h-full pointer-events-none opacity-[0.06] z-0" viewBox="0 0 1440 600" preserveAspectRatio="none">
          <defs>
            <linearGradient id="f5g" x1="0" y1="0" x2="1" y2="0">
              <stop offset="0%" stopColor="#3b82f6" />
              <stop offset="100%" stopColor="#06b6d4" />
            </linearGradient>
          </defs>
          <path d="M0,300 C200,100 400,500 720,300 C1040,100 1240,500 1440,300" stroke="url(#f5g)" strokeWidth="1.5" fill="none" strokeDasharray="8 12"
        ...
        <div className="max-w-3xl mx-auto text-center">
          <Reveal>
            ...
            <div className="flex items-center justify-center gap-4 flex-wrap">
              <MagneticBtn to="/login">Σύνδεση στο AION FLOW <ArrowRight size={16} /></MagneticBtn>
              <MagneticBtn to="/dashboard" primary={false}>Δείτε Demo <ChevronRight size={16} /></MagneticBtn>
            </div>
          </Reveal>
        </div>
