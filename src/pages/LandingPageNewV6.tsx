  ...
  return (
    <div className="relative leading-[0] -mt-[1px] overflow-hidden z-10">
      <svg viewBox="0 0 1440 60" preserveAspectRatio="none" className="w-full h-[40px] md:h-[60px]">
        <path
          d="M0,40 C240,10 480,55 720,30 C960,5 1200,50 1440,25 L1440,0 L0,0 Z"
          fill={fill}
          style={{ animation: 'waveAnim 6s ease-in-out infinite' }}
        />
      </svg>
    </div>
  );
...
function Particles({ color = 'rgba(59,130,246,' }: { color?: string }) {
...
function MagneticBtn({ to, primary = true, children }: { to: string; primary?: boolean; children: React.ReactNode }) {
  ...
  return (
    <Tag {...props} className={`inline-flex items-center gap-2 px-8 py-3.5 rounded-xl text-base font-medium transition-all duration-300 hover:scale-[1.02] ${
      primary
        ? 'bg-blue-600 text-white hover:bg-blue-500 shadow-lg shadow-blue-500/20 hover:shadow-xl hover:shadow-blue-500/30'
...
/* ═══ PAGE ══════════════════════ */
export default function LandingPageNewV6() {
    ...
    <div className="min-h-screen bg-stone-50 text-gray-900 overflow-x-hidden relative">
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 px-6 py-4 flex items-center justify-between transition-all duration-300 ${
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <Link to="/dashboard" className="bg-blue-600 hover:bg-blue-500 text-white font-medium px-5 py-2.5 rounded-xl flex items-center gap-2 text-sm shadow-lg shadow-blue-500/25 transition-all hover:scale-[1.02]">
      ...
      <section id="hero" className="relative min-h-screen flex items-center px-6 pt-24 pb-16 overflow-hidden bg-stone-50">
        ...
        <Particles color="rgba(59,130,246," />
        ...
        <div className="relative w-full max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center z-10">
          ...
          <div className="relative">
            ...
            <div className="relative bg-white/80 backdrop-blur-xl rounded-2xl p-6 md:p-8 shadow-2xl border border-white/60"
              style={{ animation: 'floatPill 8s ease-in-out infinite' }}>
              ...
              {modules.map((m, i) => {
                ...
                return (
                  <Reveal key={i} delay={i * 80}>
                    <div className="card-lift bg-stone-50 border border-gray-200/80 p-6 rounded-2xl cursor-default">
