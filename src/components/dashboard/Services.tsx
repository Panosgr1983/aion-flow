...
const emptyForm: Partial<Service> = { tenant_id: null, title: '', slug: '', short_description: '', long_description: '', icon: 'heart', sort_order: 0, is_active: true, meta_title: '', meta_description: '', og_image: '' };
