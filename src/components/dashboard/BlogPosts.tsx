...
const emptyForm: Partial<BlogPost> = { tenant_id: null, title: '', slug: '', excerpt: '', content: {}, category: '', image_url: '', is_published: false, published_at: null, meta_title: '', meta_description: '', og_image: '', show_on_service_page: false };
